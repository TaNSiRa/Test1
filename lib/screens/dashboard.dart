...
class _DashboardState extends State<Dashboard> {
  ...
  //สร้างฟังก์ชั่นสำหรับอ่านข้อมูล user จาก SharedPreferences
  ...
  //ส่วนของการกำหนด Bottom Navigation Bar
  //กำนดค่าตัวแปร currentIndex ให้เป็น 0
  int _currentIndex = 0;
  ...
  void onTabTapped(int index) {
    setState(() {
      ...
      switch (index) {
        case 0:
          _title = 'Dashboard'; break;
        case 1:
          _title = 'Machine'; break;
        case 2:
          _title = 'Profile'; break;
      }
    });
  }
